...
export function encryptAddressBookSecret(value) {
    if (!value)
        return value ?? null;
...
export function decryptAddressBookSecret(value) {
    if (!value)
        return value ?? null;
    if (!value.startsWith(encryptedPrefix))
        return value;
...
export function hasAddressBookSecret(value) {
...
export function decryptIdentityProviderSecrets(provider) {
    return {
        ...provider,
